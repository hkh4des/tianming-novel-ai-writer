## P.s：不需要刻意进群，开源版自己部署，不需要卡密，不需要卡密，不需要卡密，查看 开源说明.md，如果连中文都看不明白，不建议使用，如果用正式版，请遵守我的要求！
## 交流群
...
[![Version](https://img.shields.io/badge/Version-2.8.8-blue.svg)](https://github.com/zy-zmc/tianming-novel-ai-writer/releases)
...
本仓库已完成开源清理（加密保护系统已移除、私有域名已替换占位符）。详见 [开源说明.md](开源说明.md)。
